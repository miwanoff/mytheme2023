    ...
    class WPAICG_Audio
    {
        ...
        public function wpaicg_audio_converter()
        {
            ...
            if($type == 'upload' && !isset($_FILES['file'])){
                $wpaicg_result['msg'] = 'An audio file is mandatory.';
                wp_send_json($wpaicg_result);
            }
            if(($response == 'post' || $response == 'page') && empty($title)){
                $wpaicg_result['msg'] = 'Please insert title';
                wp_send_json($wpaicg_result);
            }
            if($type == 'upload'){
                $file = $_FILES['file'];
            ...
            if($type == 'url'){
                if(empty($url)){
                    $wpaicg_result['msg'] = 'The audio URL is required';
                    wp_send_json($wpaicg_result);
                }
            ...
            if(!method_exists($open_ai, $purpose)){
                $wpaicg_result['msg'] = 'Method does not exist';
                wp_send_json($wpaicg_result);
            }
            if($type == 'url'){
            ...
            if(empty($text_generated)){
                $wpaicg_result['msg'] = 'OpenAI returned empty content';
                wp_send_json($wpaicg_result);
            }
