    ...
    final class WPAICG_Content
    {
        ...
        public function wpaicg_speech_record()
        {
            ...
            if(empty($text_generated)){
                $wpaicg_result['msg'] = 'Please speak louder or say more words for accurate recognition.';
                wp_send_json($wpaicg_result);
            }
            $wpaicg_data_request = [
                'model' => 'gpt-3.5-turbo',
            ...
            if ( empty($wpaicg_cron_added) ) {
                ...
                if ( $wpaicg_single ) {
                    ...
                    try {
                        ...
                        if(!$openai){
                            $this->wpaicg_bulk_error_log($wpaicg_single->ID, 'Missing API Setting');
                        }
                        else{
                            ...
                            if($wpaicg_has_error){
                                $this->wpaicg_bulk_error_log($wpaicg_single->ID, $wpaicg_has_error.'. Break at step '.$break_step);
