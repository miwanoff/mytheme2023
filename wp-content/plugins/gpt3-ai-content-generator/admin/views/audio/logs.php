...
<div>
    <div class="wpaicg-mb-10">
        <form action="" method="GET">
            ...
            <input value="<?php echo esc_html($search)?>" name="search" type="text" placeholder="Search Audio">
        ...
        foreach ($wpaicg_audios->posts as $wpaicg_audio){
            ...
            <tr>
                ...
                <td>
                    ...
                    if($wpaicg_response != 'post' && $wpaicg_response != 'page'):
                    ?>
                        <a download href="<?php echo site_url('index.php?wpaicg_download_audio='.$wpaicg_audio->ID)?>" class="button button-primary button-small">Download</a>
                    <?php
                    endif;
                    ?>
                    <a onclick="return confirm('Are you sure?')" href="<?php echo admin_url('admin.php?page=wpaicg_audio&action=logs&audio_delete='.$wpaicg_audio->ID)?>" class="button button-link-delete button-small">Delete</a>
                </td>
            </tr>
            <?php
        }
...
<script>
    jQuery(document).ready(function ($){
        ...
        $('.wpaicg-view-content').click(function (){
            ...
            $('.wpaicg-overlay').show();
            $('.wpaicg_modal').show();
            $('.wpaicg_modal_title').html('View Content');
