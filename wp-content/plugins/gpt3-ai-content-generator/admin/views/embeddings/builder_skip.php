...
<div class="tablenav top">
    <div class="alignleft actions bulkactions">
        <a href="<?php echo admin_url('admin.php?page=wpaicg_embeddings&action=builder&sub=skip&sub_action=reindexall')?>" class="button button-primary">Re-Index All</a>
...
<div class="tablenav top">
    <div class="alignleft actions bulkactions">
        ...
        Skipped (<?php echo esc_html(count($wpaicg_total_skips))?>)
    </div>
</div>
        ...
        $('.btn-reindex-builder').click(function (){
            ...
            if(ids.length){
                $.ajax({
                    ...
                    data: {action: 'wpaicg_reindex_builder_data', ids: ids},
                    dataType: 'JSON',
                    type: 'POST',
                    beforeSend: function () {
                        wpaicgLoading(btn);
