...
<div id="help_tabs-2">
  ...
  <h3>Express Mode</h3>
        <div>
          ...
          <p>By default, Express Mode generates 5 headings and 500 word article for each heading.</p>
        </div>
  <h3>Custom Mode</h3>
        <div>
    ...
    <h3>Language, Style and Tone</h3>
        <div>
          <p>GPT AI Power supports 41 languages:</p>
          <p>Afrikaans, Arabic, Armenian, Bosnian, Bulgarian, Chinese, Croatian, Czech, Danish, Dutch, English, Estonian, Filipino, Finnish, French, German, Greek, Hebrew, Hindi, Hungarian, Indonesian, Italian, Japanese,
