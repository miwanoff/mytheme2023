...
<div class="wrap fs-section wpaicg-image-generator<?php echo isset($wpaicg_image_shortcode) && $wpaicg_image_shortcode ? ' wpaicg-image-shortcode':''?>">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="<?php echo admin_url('admin.php?page=wpaicg_image_generator&action=logs')?>" class="nav-tab<?php echo esc_html($wpaicg_action) == 'logs' ? ' nav-tab-active' : ''?>">Logs</a>
        <a href="<?php echo admin_url('admin.php?page=wpaicg_image_generator&action=settings')?>" class="nav-tab<?php echo esc_html($wpaicg_action) == 'settings' ? ' nav-tab-active' : ''?>">Settings</a>
    </h2>
    <?php
    endif;
    ?>
