    ...
    <div class="wpaicg-comparison-item wpaicg-comparison-item-[ID]">
        <form action="" method="post" class="wpaicg-comparison-form">
            ...
            <div class="wpaicg-mb-10 wpaicg-comparison-height" style="justify-content: space-between">
                <button class="button button-primary wpaicg-comparison-submit">Generate</button>
                <span class="wpaicg-comparison-space" style="display: none">&nbsp;&nbsp;</span>
                <button style="display: none" type="button" class="button button-link-delete wpaicg-comparison-cancel">Cancel</button>
            </div>
            <div class="wpaicg-mb-10 wpaicg-comparison-second">
...
<div class="comparison_tool">
    <div style="padding: 10px 0px">
        ...
        <div class="wpaicg-mb-10 wpaicg-comparison-second"><strong>Prompt:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Engine:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Temp:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Max Token:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Top P:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Fre. P:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Pre. P:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-second"><strong>Output:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Token:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Cost:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Duration:</strong></div>
        <div class="wpaicg-mb-10 wpaicg-comparison-height"><strong>Word:</strong></div>
    </div>
</div>
<script>
