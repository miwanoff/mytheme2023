            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="button-small button button-link-delete" onclick="return confirm('Are you sure?')" href="<?php echo esc_url(admin_url('admin.php?page=wpaicg_chatgpt&action=bots&wpaicg_bot_delete='.$wpaicg_bot->ID))?>">Delete</a>
                    </td>
                </tr>
            <?php
            }
