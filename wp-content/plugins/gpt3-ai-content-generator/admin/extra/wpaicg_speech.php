...
<p style="font-style: italic">"Write a blog post about the latest mobile phones and their features. Include an introduction that highlights the importance of mobile phones in today's world. In the body of the post, discuss the latest mobile phone trends, such as foldable screens, 5G connectivity, and high refresh rate displays. Also, mention the most popular mobile phone brands and their latest releases. Don't forget to discuss the benefits and drawbacks of each phone and how they compare to one another. In the conclusion, summarize the key points of the post."
</p>
<button class="button button-primary button-hero btn-start-record" style="display: inline-flex"><span class="dashicons dashicons-microphone"></span>Speak</button>
<button class="button button-primary button-hero btn-pause-record" style="display: none"><span class="dashicons dashicons-controls-pause"></span>Pause</button>
<button class="button button-link-delete button-hero btn-stop-record" style="display: none"><span class="dashicons dashicons-saved"></span>Stop</button>
<button class="button button-link-delete button-hero btn-abort-record" style="display: none"><span class="dashicons dashicons-no"></span>Cancel</button>
<p class="wpaicg-sending-record" style="display:none;width: 150px; text-align: left">
    <button class="button button-link-delete button-hero btn-cancel-record" style="display: inline-flex;color: #0b9529;"><span class="spinner" style="visibility: unset;margin-top: 0"></span>Generating Content..Please Wait..</button><br>
    [Click to cancel]
</p>
<p></p>
...
<div class="wpaicg-speech-result" style="margin-top: 20px;display: none">
    <div class="wpaicg-mb-10">
        <input type="text" class="regular-text wpaicg-speech-title" style="width: 100%;font-size: 20px" placeholder="Enter a Post Title">
    </div>
    <div class="mb-5"><strong>Post Content</strong></div>
    <div class="wpaicg-mb-10">
        <?php
    ...
    <button class="button button-primary wpaicg-audio-save">Save Draft</button>
</div>
<script>
    jQuery(document).ready(function ($){
        ...
        wpaicgSaveAudio.click(function (){
            ...
            if(title === ''){
                alert('Please insert a title before saving.');
                return;
            }
            if(content === ''){
                alert('Please record a speech before saving.');
                return;
            }
            $.ajax({
                url: '<?php echo admin_url('admin-ajax.php')?>',
                ...
                success: function (res){
                    ...
                    if(res.status === 'success'){
                        wpaicgSpeechMessage.html('<span style="color: #26a300; font-weight: bold;display: block;margin-top: 10px;">Your post has been saved successfully. You can view its details under the Logs tab.</span>');
        ...
        wpaicgPauseRecord.click(function (){
            if(wpaicgPauseRecord.hasClass('wpaicg-paused')){
                wpaicgPauseRecord.html('<span class="dashicons dashicons-controls-pause"></span>Pause')
                wpaicgPauseRecord.removeClass('wpaicg-paused');
            }
            else{
                wpaicgPauseRecord.html('<span class="dashicons dashicons-controls-play"></span>Continue')
