...
<p class="wpaicg_notice_text">You can design AI forms and embed them easily into your website. Watch video tutorial <a href="https://www.youtube.com/watch?v=hetYOlR-ms4" target="_blank">here</a>.<br><br>
    ...
    jQuery(document).ready(function ($){
        ...
        $(document).on('click','.wpaicg-template-item .wpaicg-template-action-delete',function (e){
            ...
            if(conf){
                ...
                $.post('<?php echo admin_url('admin-ajax.php')?>', {action: 'wpaicg_template_delete', id: id});
            }
        });
