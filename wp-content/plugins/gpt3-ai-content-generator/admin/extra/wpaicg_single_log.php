...
<div>
    <div class="wpaicg-mb-10">
        <form action="" method="GET">
            ...
            <input value="<?php echo esc_html($search)?>" name="search" type="text" placeholder="Search">
    ...
    if($wpaicg_single_logs->have_posts()) {
        foreach ($wpaicg_single_logs->posts as $wpaicg_single_log) {
            ...
            <tr>
                ...
                <td><?php echo $wpaicg_source_log == 'speech' ? 'Speech-to-Post' : ($wpaicg_source_log == 'custom' ? 'Custom Mode' :'Express Writer')?></td>
