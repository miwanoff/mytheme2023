...
// Verify nonce
if ( isset( $_GET['wpaicg_search_logs_nonce'] ) && ! wp_verify_nonce( $_GET['wpaicg_search_logs_nonce'], 'wpaicg_search_logs' ) ) {
...
<form action="" method="get">
    ...
    <?php wp_nonce_field( 'wpaicg_search_logs', 'wpaicg_search_logs_nonce' ); ?>
