...
$image_url = !post_password_required() ? get_the_post_thumbnail_url(get_the_ID(), 'kit-fullscreen') : '';
 ...
 */
$show_categories = apply_filters('kit_show_categories_in_entry_header', true);
    ...
    ?>
								...
								<div class="to-the-content-wrapper">
									...
									<a href="#post-inner" class="to-the-content fill-children-current-color">
										<?php kit_the_theme_svg('arrow-down');?>
...
/* translators: Hidden accessibility text. */
    ...
    kit_the_post_meta(get_the_ID(), 'single-top');
...
wp_link_pages(
    array(
        'before' => '<nav class="post-nav-links bg-light-background" aria-label="' . esc_attr__('Page', 'kit') . '"><span class="label">' . __('Pages:', 'kit') . '</span>',
        'after' => '</nav>',
...
kit_the_post_meta(get_the_ID(), 'single-bottom');
