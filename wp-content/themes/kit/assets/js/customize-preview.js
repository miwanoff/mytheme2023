/* global kitBgColors, kitPreviewEls, jQuery, _, wp */
/**
...
(function ($, api, _) {
  ...
  api("accent_hue", function (value) {
    value.bind(function () {
      ...
      setTimeout(function () {
        Object.keys(kitBgColors).forEach(function (context) {
          kitGenerateColorA11yPreviewStyles(context);
        });
      }, 50);
    });
  });
  ...
  Object.keys(kitBgColors).forEach(function (context) {
    wp.customize(kitBgColors[context].setting, function (value) {
      value.bind(function () {
        // Generate the styles.
        // Add a small delay to be sure the accessible colors were generated.
        setTimeout(function () {
  ...
  function kitGenerateColorA11yPreviewStyles(context) {
    ...
    if (!_.isUndefined(a11yColors[context])) {
      ...
      if (kitPreviewEls[context]) {
        _.each(kitPreviewEls[context], function (items, setting) {
  ...
  $(function () {
    kitGenerateColorA11yPreviewStyles("content");
    kitGenerateColorA11yPreviewStyles("header-footer");
  });
